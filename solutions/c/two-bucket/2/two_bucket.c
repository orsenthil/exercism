...
static bool is_possible(bucket_liters_t bucket_1_size, bucket_liters_t bucket_2_size, bucket_liters_t goal_volume)
{
...
bucket_result_t measure(bucket_liters_t bucket_1_size, bucket_liters_t bucket_2_size,
